...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-nav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link link-text" href="showPeople.php">ข้อมูลบุคลากร</a>
            </li>
            <li class="nav-item">
                <a class="nav-link link-text" href="showCompany.php">ความร่วมมือกับสถาณประกอบการ</a>
            </li>
        </ul>

        <span class="navbar-text text-name">
            <?php echo $_SESSION["user_dep"];?>
        </span>
