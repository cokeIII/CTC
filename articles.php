...
<div class="form-input">
    ...
    <label for="cash">โปรเจคเตอร์</label>
    <span class="check"></span></div></div>
    <div class="form-radio-item">
      <input type="radio" name="type_k" id="cash" checked>
    <label for="cash">ทีวี</label>
    <span class="check"></span></div>
    <div class="form-radio-item">
      <input type="radio" name="type_k" id="cash" checked>
    <label for="cash">จอภาพอัจฉริยะ</label>
    <span class="check"></span></div>
    <div class="form-radio-item">
      <input type="radio" name="type_k" id="cash" checked>
    <label for="cash">อื่นๆ</label><span class="check"></span>
</div>
</div>
</div>
</div>
