        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <div class="row mt-5 ml-3"><button class="btn btn-primary "><a href="dur_art.php" class="txt-link">เพิ่มข้อมูล</a></button></div>
                        ...
                        <table class="table  " id="durTable">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><button class="btn btn-warning"><a href="formEditDur.php?dur_id=<?php echo $row["dur_id"]?>"><i class="icon-color fa fa-pencil-square"></i></a></button></td>
                                    <td><button class="btn btn-danger"><a href="sqlDurArticles.php?dur_id=<?php echo $row["dur_id"]?>&delDur=true"><i class="icon-color fa fa-trash"></i></a></button></td>
                                </tr>
                                <?php
                                    }
                                }
